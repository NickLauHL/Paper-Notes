...
paper_info:
  authors: "Jeffry A. Simpson.et.al"
  venue: "Journal of Consumer Psychology"
  year: 2012
  link: "https://doi.org/10.1016/j.jcps.2011.09.007"
---

## We introduce a dyadic framework of decision-making to study decisions within relationships. We then discuss how the study of consumer decisions in relationships can be informed by different theories in the relationships field.

## Research Question

Prior literature provided limited guidance as to how, when, or why other individuals in a relationship with the decision-maker directly or indirectly affect decision-making.

## Literature Review And Theoretical Development

<span style="color: red; font-weight: bold">A dyadic model</span>

It is based on a statistical technique known as the Actor-Partner Interdependence Model (Kenny, D. A., Kashy, D. A., & Cook, W. (2006). Dyadic data analysis. New York: Guilford Press.);
